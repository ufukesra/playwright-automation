...
test.describe('Payment iframe handling', () => {
  ...
  test('Handling the payment iframe', async ({ page }) => {
    ...
    let linkedin= page.locator("//span[contains(@class, 'mdc-list-item__primary-text') and text()='LinkedIN']");
